...
-- Weekly breakdown of a monthly curriculum theme (see migration 006).
...
-- Daily rhythm: one reusable template of time blocks per program, same every
-- weekday. Blocks auto-fill from the month theme / week plan via `source`
-- (migration 012).
